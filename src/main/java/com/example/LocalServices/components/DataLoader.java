...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Service service1 = new Service("Shoe Repair", "one pair of shoes reheeled and resoled", 9.99, 60);
        serviceRepository.save(service1);

        Service service2 = new Service("Facial", "Relax in elegant surroundings and enjoy a rejuvinating facial made to match your skins needs", 30.00, 60);
        serviceRepository.save(service2);

        Service service3 = new Service("Manicure", "Choose from French Manicure or luxury hand massage and polish", 24.99, 30);
        ...
        Booking booking1 = new Booking(LocalDate.parse("2021-01-15"), LocalDate.parse("2021-01-30"), LocalTime.parse("10:30"), LocalTime.parse("11:30"), "1 pair of brown leather boots to be re- heeled and re-soled please", user1, service1);
        bookingRepository.save(booking1);

        Booking booking2 = new Booking(LocalDate.parse("2021-01-05"), LocalDate.parse("2021-02-06"), LocalTime.parse("13:00"), LocalTime.parse("14:30"), "facial for dry skin and a luxury manicure please", user2, service2);
        bookingRepository.save(booking2);

        Booking booking3 = new Booking(LocalDate.parse("2020-12-29"),LocalDate.parse("2021-01-15"),LocalTime.parse("12:00"), LocalTime.parse("13:30"), "french manicure", user1, service3);
